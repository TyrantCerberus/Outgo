...
/obj/item/paper/fluff/jobs/chemistry/painkiller_recipes
	name = "paper- 'Painkiller Recipes'"
	info = {"<b>Paracetamol</b> - Combine acetone, sugar and ethanol in equal measure.<br><br>
	<b>Tramadol</b> - Combine equal parts sodium chloride, hydrogen, chlorine, ethanol and potassium.<br><br>
	<b>Oxycodone</b> - Mix one part tramadol to one part morphine, catalyze with at least 5 units of plasma.<br><br>
	<b>Warning: Do not administer tramadol and oxycodone simultaneously!</b>
	"}
