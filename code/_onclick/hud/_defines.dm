...
#define ui_pain "EAST-1:28,CENTER+3:17"
...
//Ghosts
#define ui_ghost_orbit "SOUTH:6,CENTER-2:16"
#define ui_ghost_reenter_corpse "SOUTH:6,CENTER-1:16"
#define ui_ghost_teleport "SOUTH:6,CENTER:16"
#define ui_ghost_activities "SOUTH: 6, CENTER+1:16"
#define ui_ghost_spawners_menu "SOUTH+1:6,CENTER-2"
#define ui_ghost_pai "SOUTH+1:6, CENTER-1"
#define ui_ghost_mafia "SOUTH+1:6, CENTER"
#define ui_ghost_dm "SOUTH+1:6, CENTER+1"
#define ui_ghost_ctf "SOUTH+1:6, CENTER+2"
#define ui_ghost_language_menu "SOUTH: 22, CENTER+2"
