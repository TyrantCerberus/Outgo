...
/obj/item/stack
	...
	var/obj/structure/table/tableVariant // we tables now (stores table variant to be built from this stack)
		...
		// The following are all for medical treatment, they're here instead of /stack/medical because sticky tape can be used as a makeshift bandage
	/// How much blood flow this stack can absorb if used as a bandage on a body part.
	var/absorption_capacity
	/// How much blood this stack lets through.
	var/seepage_percentage
