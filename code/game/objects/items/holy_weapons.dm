...
/obj/item/nullrod/proc/reskin_holy_weapon(mob/user)
	...
	var/choice = show_radial_menu(user, src , nullrod_icons, custom_check = CALLBACK(src, PROC_REF(check_menu), user), radius = 42, require_near = TRUE)
...
/obj/item/nullrod/egyptian
	name = "egyptian staff"
	desc = "A tutorial in mummification is carved into the staff. You could probably craft the wraps if you had some gauze."
	icon = 'icons/obj/guns/magic.dmi'
