...
/obj/machinery/limbgrower
	...
	var/list/categories = list(SPECIES_HUMAN, SPECIES_LIZARD, SPECIES_MOTH, SPECIES_PLASMAMAN, "other")
...
/obj/machinery/limbgrower/proc/build_limb(buildpath)
	...
	var/list/greyscale_species = list(SPECIES_HUMAN, SPECIES_LIZARD)
