...
/datum/objective_item/steal/plasma
	...
	difficulty = 3
	excludefromjob = list("Chief Engineer","Research Director","Station Engineer","Junior Engineer","Scientist","Lab Technician","Atmospheric Technician")
...
/datum/objective_item/steal/blackbox
	...
	difficulty = 10
	excludefromjob = list("Chief Engineer","Station Engineer","Junior Engineer","Atmospheric Technician")
